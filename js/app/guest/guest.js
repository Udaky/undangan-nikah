...
export const guest = (() => {
  ...
  const buildGoogleCalendar = () => {
    ...
    const data = new URLSearchParams({
      action: "TEMPLATE",
      text: "The Wedding of Nindi and Rizky",
      dates: `${formatDate("2025-10-22 10:00")}/${formatDate(
        "2025-10-22 17:00"
      )}`,
      details:
      ...
      location:
        "Jorong Sungai Tambang I, Nagari Kunangan Parik Rantang, Kec. Kamang Baru, Kab, Sijunjung.",
      ctz: config.get("tz"),
    });
